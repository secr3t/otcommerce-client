...
func TestCompoundClient_SearchAndGetDetails(t *testing.T) {
	c := NewCompoundClient("xxxx", 400)

	p := SearchParamFromUri(0, "https://s.taobao.com/search?spm=a2141.241046-cn.lead_cate3.1.41ca6f111NlbIp&q=%E9%AB%98%E5%B0%94%E5%A4%AB&imgfile=&js=1&stats_click=search_radio_all%3A1&initiative_id=staobaoz_20210402&ie=utf8")
